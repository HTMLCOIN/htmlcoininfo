...
const hrc20List = require('./hrc20-abi.json')
const hrc721List = require('./hrc721-abi.json')
...
const hrc20ABIs = transformABIList(hrc20List)
const hrc721ABIs = transformABIList(hrc721List)

Object.assign(exports, {MethodABI, EventABI, hrc20ABIs, hrc721ABIs})
